package com.dysen.opencard.common.costomview;
...
public class LabelsView extends ViewGroup implements View.OnClickListener {
	...
	//用于保存label数据的key
	private static final int KEY_DATA = -1;//R.id.tag_key_data
	//用于保存label位置的key
	private static final int KEY_POSITION = -2;//R.id.tag_key_position
