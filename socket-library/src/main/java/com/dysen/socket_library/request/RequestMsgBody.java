...
/*  41 */     Element rootElement = document.getRootElement();
/*  42 */     List fieldElementList = rootElement.elements("MsgField");
/*  43 */     for (int i = 0; i < fieldElementList.size(); ++i)
/*     */     {
/*  45 */       Element fieldElement = (Element)fieldElementList.get(i);
/*  46 */       String id = fieldElement.attributeValue("id");
/*  47 */       String lengthValue = fieldElement.attributeValue("length");
/*  48 */       String typeValue = fieldElement.attributeValue("type");
/*  49 */       String defaultValue = fieldElement.attributeValue("default");
/*  51 */       int length = Integer.parseInt(lengthValue);
/*     */       int type;
/*  53 */       switch (typeValue)
/*     */       {
/*     */       case "N":
...
/*     */       }
/*     */ 
/*  77 */       MsgField field = new MsgField(defaultValue, length, type, id);
/*  78 */       this.fieldList.add(field);
/*  79 */       this.fieldIndexMap.put(id, Integer.valueOf(i));
/*     */     }
/*     */   }
/*     */ 
/*     */   public MsgField getMsgField(String id)
/*     */   {
/*  90 */     Integer index = (Integer)this.fieldIndexMap.get(id);
/*  91 */     if (index == null)
/*     */     {
/*  93 */       return null;
/*     */     }
/*     */ 
/*  96 */     return (MsgField)this.fieldList.get(index.intValue());
/*     */   }
/*     */ 
/*     */   public List<MsgField> getBodyData()
/*     */   {
/* 105 */     return this.fieldList;
/*     */   }
/*     */ }
