...
/*     */   {
/*  34 */     this.GDTA_ITEMDATA_HEAD = head.getHeadData();
/*  35 */     this.GDTA_ITEMDATA_BODY = body.getBodyData();
/*  36 */     for (int i = 0; i < this.GDTA_ITEMDATA_HEAD.size(); ++i)
/*     */     {
/*  38 */       this.GDTA_ITEMDATA += ((MsgField)this.GDTA_ITEMDATA_HEAD.get(i)).getFieldValue();
/*     */     }
/*  40 */     for (int i = 0; i < this.GDTA_ITEMDATA_BODY.size(); ++i)
/*     */     {
/*  42 */       this.GDTA_ITEMDATA += ((MsgField)this.GDTA_ITEMDATA_BODY.get(i)).getFieldValue();
/*     */     }
/*     */
/*  45 */     String msgCode = body.MSG_CODE;
/*  46 */     this.GDTA_SVCNAME.setValue(msgCode);
/*     */
/*  48 */
				byte[] mac = new byte[0];
...
/*     */     {
/*  52 */       hexMac = hexMac + FormatUtil.byteToHexString(mac[i], true);
/*     */     }
/*     */
/*  55 */     this.GDTA_MAC.setValue("1111111111111111");
...
/*  57 */     int length = this.TRAN_CODE.getLength() + this.GDTA_SVCNAME.getLength() + ItemDataLength + this.HB_NEW_PWD16_1.getLength() + this.HB_NEW_PWD16_2.getLength() + this.HB_NEW_PWD16_3.getLength() + this.GDTA_MAC.getLength();
/*  58 */     this.GDTA_ITEMDATA_LENGTH.setValue(String.valueOf(length));
/*     */   }
/*     */
...
/*     */   public byte[] getMsg()
/*     */   {
/*  74 */     byte[] msg = new byte[this.GDTA_ITEMDATA_LENGTH.getLength() + this.TRAN_CODE
...
/*  77 */
	...
	if(this.GDTA_SVCNAME.getFieldValue().equals("311077")||this.GDTA_SVCNAME.getFieldValue().equals("311070")){
		...
		/*  84
/*  85 */     System.arraycopy(this.HB_NEW_PWD16_1.getFieldValue().getBytes(), 0, msg, pos, this.HB_NEW_PWD16_1.getLength());
/*  86 */     pos += this.HB_NEW_PWD16_1.getLength();
/*  87 */     System.arraycopy(this.HB_NEW_PWD16_2.getFieldValue().getBytes(), 0, msg, pos, this.HB_NEW_PWD16_2.getLength());
/*  88 */     pos += this.HB_NEW_PWD16_2.getLength();
/*  89 */     System.arraycopy(this.HB_NEW_PWD16_3.getFieldValue().getBytes(), 0, msg, pos, this.HB_NEW_PWD16_3.getLength());
/*  90 */     pos += this.HB_NEW_PWD16_3.getLength();
/*  91 */     System.arraycopy(this.GDTA_MAC.getFieldValue().getBytes(), 0, msg, pos, this.GDTA_MAC.getLength());
	}
/*     */
/*  93 */     logMsgInfo();
/*  78 */
...
/*     */   {
/* 102 */     this.GDTA_ITEMDATA_LENGTH.logFieldInfo();
/* 103 */     this.TRAN_CODE.logFieldInfo();
/* 104 */     this.GDTA_SVCNAME.logFieldInfo();
/* 105 */     for (int i = 0; i < this.GDTA_ITEMDATA_HEAD.size(); ++i)
/*     */     {
/* 107 */       ((MsgField)this.GDTA_ITEMDATA_HEAD.get(i)).logFieldInfo();
/*     */     }
/* 109 */     for (int i = 0; i < this.GDTA_ITEMDATA_BODY.size(); ++i)
/*     */     {
/* 111 */       ((MsgField)this.GDTA_ITEMDATA_BODY.get(i)).logFieldInfo(i + 1);
/*     */     }
/* 113 */     this.HB_NEW_PWD16_1.logFieldInfo();
/* 114 */     this.HB_NEW_PWD16_2.logFieldInfo();
/* 115 */     this.HB_NEW_PWD16_3.logFieldInfo();
/* 116 */     this.GDTA_MAC.logFieldInfo();
/*     */   }
/*     */ }
